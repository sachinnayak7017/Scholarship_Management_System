...
public  class ForgetPass extends JFrame implements ActionListener {
    ...
    ForgetPass() {
        ...
        JLabel jb0 = new JLabel("UPDATE  PASSWORD FOR ADMIN");
...
//            }
                ...
                try {
                    ...
                    Connection conn = DriverManager.getConnection(datbaseurl, Username, Password);
                    System.out.println("Database Connected");
                    String q = "update  adminsup set  Department ='" + Department + "',Name ='" + Name + "',Gender ='" + Gender + "',Password ='" + Password1 + "'where Email ='" + Email + "'";
                    Statement stmt = conn.createStatement();
                    stmt.executeUpdate(q);
                    JOptionPane.showMessageDialog(null, "Admin Information Successfully Update ");

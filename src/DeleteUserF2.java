...
public class DeleteUserF2 extends JFrame implements ActionListener {
...
//            while(rs.next())
//            {
//                cho.add(rs.getString("10th_Roll_no"));
//            }
//        }catch (Exception ex1) {
//            ex1.printStackTrace();
//        }
...
//                    Connection conn = DriverManager.getConnection(datbaseurl, Username, Password);
//                    System.out.println("Database Connected");
//                    String q =" select * from StudentInformation2 where 10th_Roll_no='"+cho.getSelectedItem()+"'";
//                    Statement stmt = conn.createStatement();
...
//                    String q2 = "delete from  studentInformation2   where 10th_Roll_no='" + Roll10 + "'";
//                    Statement stmt = conn.createStatement();
//                    stmt.executeUpdate(q2);
                    JOptionPane.showMessageDialog(null, "Your data Successfully Delete");

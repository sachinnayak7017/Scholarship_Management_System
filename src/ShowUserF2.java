...
public  class ShowUserF2 extends JFrame implements ActionListener {
    ...
    ShowUserF2() {
        ...
        try{
            ...
            Connection conn = DriverManager.getConnection(datbaseurl, Username, Password);
            System.out.println("Database Connected");
            String q2="select * from  StudentInformation2 ";
            Statement stmt = conn.createStatement();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==search) {
            String q3 = "select * from StudentInformation2 where 10th_Roll_no='" + cho.getSelectedItem() + "'";

...
public class UpdateUserF1 extends JFrame implements ActionListener {
    JFrame F;
    JButton next;
    JButton submit1;
    JButton close;
...
//                Connection conn = JdbcConnection.getConnection();
                String q = "Update  StudentInfo2 set Enrolment='" + Enrolment + "' ,Name='" + Name + "',Course='" + Course + "',Branch='" + Branch + "',Entry_Year='" + EyearUni + "',Aadhaar_no='" + Aadhaar + "',State='" + State + "',Graduation_Year='" + GraduYear + "',CGPA='" + Cgpa + "',SGPA='" + Sgpa + "',Percentage='" + Percentage+ "',Cateagary='" + Cateagary + "',Attends='" + Attends + "',Address='"  + Address + "' where RollNo='" + Roll + "'";
                Statement stmt = conn.createStatement();
                ...
                F.setVisible(false);
                new UpdateUserF2(Roll).setVisible(true);
            }catch (Exception ex2)
        {

...
public  class AdminSUp extends JFrame implements ActionListener {
    ...
    AdminSUp() {
        ...
        JLabel jb0 = new JLabel("Enter  Admin  Information");
        jb0.setBounds(350, 80, 500, 40);
...
//            }
                ...
                try {
                    ...
                    String q = "insert into adminsup value ( '" + Email + "'  ,'" + Department + "','" + Name + "','" + Gender + "','" + Password1 + "')";
